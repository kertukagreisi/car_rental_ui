...
class CarDetailsPage extends ViewModelWidget<CarDetailsViewModel> {
  ...
  @override
  Widget builder(
      BuildContext context, CarDetailsViewModel viewModel, Widget? child) {
    return Container(
      color: Colors.white,
          ...
          children: [
            Padding(
              ...
              child: Row(
                children: _buildRatingWidget(
                    viewModel.car.averageRating!, viewModel.car.reviewsCount!),
              ),
            ),
            Padding(
              padding: const EdgeInsets.only(bottom: 12.0),
              child: Text('${viewModel.car.brand} ${viewModel.car.model}',
                  style: Dimens.headTextStyle),
            ),
            Padding(
              padding: const EdgeInsets.only(bottom: 12.0),
              child: Text('${viewModel.car.engine} ${viewModel.car.fuelType}',
            ...
            Padding(
                ...
                child: TextButton(
                  ...
                  onPressed: () {
                    context.goNamedRoute(NavRoute.rent,
                        queryParams: args, extra: carFromExtraParameters);
                  },
                  child: Container(
  ...
  CarDetailsViewModel viewModelBuilder() {
    return getIt.get<CarDetailsViewModel>(
    ...
    ratingWidgets.add(
      Padding(
        ...
        child: Text('($reviewsCount)',
            style: Dimens.headTextStyle.copyWith(color: AppColors.yellow)),
      ),
    );
